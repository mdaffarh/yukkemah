...
@section('container')
    <div class="container-fluid">
        <h3 class="mb-4 fw-bold" style="color: var(--navy)">Tabel Merek</h3>
        <div class="card shadow">
            <div class="card-header py-3">
                <p class="text-warning m-0 fw-bold">Brands Info</p>
            </div>
            <div class="card-body">
                <!-- Form Add Start-->
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 fw-bold" style="color: var(--navy);" id="formAddLabel">
                                        Tambah Data Merek</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="/dashboard/brands" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                    ...
                    <table class="table my-0 display" id="myTable" style="width: 100%">
                        ...
                        <tbody>
                            @foreach ($brands as $b)
                                ...
                                {{-- Modal Delete --}}
                                <div class="modal fade" id="delete{{ $b->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5 fw-bold" style="color: var(--navy);"
                                                    id="deleteLabel">Hapus Data Merek</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <form action="/dashboard/brands/{{ $b->id }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <!-- Modal Edit Start-->
                                <div class="modal fade" id="edit{{ $b->id }}" data-bs-backdrop="static"
